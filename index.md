...
- [[PDF](https://github.com/google/BIG-bench/blob/main/docs/paper/BIG-bench.pdf)] With many collaborators :). 2022. **Beyond the Imitation Game: Quantifying and Extrapolating the Capabilities of Language Models**. ArXiV.
